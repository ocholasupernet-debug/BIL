...
function PrintVoucherCard({ v, plan }: { v: VoucherRow; plan?: DbPlanLite }) {
  return (
    <div style={{ width: 220, border: "1.5px dashed #06b6d4", borderRadius: 10, padding: "0.875rem", background: "white", color: "#0f172a", fontFamily: "monospace", pageBreakInside: "avoid", display: "inline-block", margin: "0.5rem" }}>
      <div style={{ textAlign: "center", fontWeight: 800, fontSize: "0.75rem", color: "#0ea5e9", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: "0.375rem" }}>
    ...
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.7)", zIndex: 1000, display: "flex", alignItems: "center", justifyContent: "center", padding: "1rem" }}>
      <div style={{ background: "var(--isp-section)", border: "1px solid var(--isp-border)", borderRadius: 16, width: "100%", maxWidth: 500, padding: "1.75rem", boxShadow: "0 25px 60px rgba(0,0,0,0.5)" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          ...
          {/* Plan preview */}
          {plan && (
            <div style={{ background: "rgba(6,182,212,0.07)", border: "1px solid rgba(6,182,212,0.2)", borderRadius: 8, padding: "0.75rem 1rem", display: "flex", gap: "1.5rem" }}>
              {[
                ...
                <div key={k}>
                  <div style={{ fontSize: "0.65rem", color: "#22d3ee", fontWeight: 600, textTransform: "uppercase" }}>{k}</div>
          ...
          <div style={{ background: "var(--isp-inner-card)", borderRadius: 8, padding: "0.75rem", display: "flex", alignItems: "center", gap: "0.5rem" }}>
            ...
            <code style={{ fontSize: "0.875rem", fontWeight: 700, color: "#22d3ee", letterSpacing: "0.12em" }}>{genCode(prefix)}</code>
          </div>
          ...
          <div style={{ display: "flex", gap: "0.75rem", marginTop: "0.25rem" }}>
            ...
            <button
              ...
              style={{ flex: 2, padding: "0.7rem", borderRadius: 10, background: generating ? "rgba(6,182,212,0.4)" : "linear-gradient(135deg,#06b6d4,#0284c7)", border: "none", color: "white", fontWeight: 700, fontSize: "0.875rem", cursor: generating ? "not-allowed" : "pointer", fontFamily: "inherit", display: "flex", alignItems: "center", justifyContent: "center", gap: "0.5rem" }}>
      ...
      <div style={{ background: "var(--isp-section)", border: "1px solid var(--isp-border)", borderRadius: 16, width: "100%", maxWidth: 760, maxHeight: "85vh", display: "flex", flexDirection: "column", overflow: "hidden" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "1.125rem 1.5rem", borderBottom: "1px solid var(--isp-border)" }}>
          ...
          <div style={{ display: "flex", gap: "0.5rem" }}>
            <button onClick={doPrint} style={{ display: "flex", alignItems: "center", gap: "0.375rem", background: "#06b6d4", border: "none", borderRadius: 8, padding: "0.5rem 1rem", color: "white", fontWeight: 700, fontSize: "0.8125rem", cursor: "pointer", fontFamily: "inherit" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
        ...
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", flexWrap: "wrap", gap: "0.75rem" }}>
          ...
          <div style={{ display: "flex", gap: "0.5rem", flexWrap: "wrap" }}>
            ...
            {selected.size > 0 && (
              <>
                <button onClick={() => setShowPrint(true)} style={{ display: "flex", alignItems: "center", gap: "0.375rem", padding: "0.5rem 0.875rem", borderRadius: 8, background: "rgba(6,182,212,0.1)", border: "1px solid rgba(6,182,212,0.25)", color: "#22d3ee", fontWeight: 600, fontSize: "0.8125rem", cursor: "pointer", fontFamily: "inherit" }}>
            ...
            <button onClick={() => setShowGenerate(true)} style={{ display: "flex", alignItems: "center", gap: "0.5rem", padding: "0.5rem 1.125rem", borderRadius: 8, background: "linear-gradient(135deg,#06b6d4,#0284c7)", border: "none", color: "white", fontWeight: 700, fontSize: "0.8125rem", cursor: "pointer", fontFamily: "inherit", boxShadow: "0 4px 12px rgba(6,182,212,0.3)" }}>
              ...
              {routers.map(r => {
                ...
                return (
                  <div key={r.id} style={{ display: "flex", alignItems: "center", gap: "0.625rem", padding: "0.5rem 0.875rem", borderRadius: 8, background: "var(--isp-inner-card)", border: `1px solid ${isOnline ? "rgba(34,197,94,0.2)" : "rgba(248,113,113,0.15)"}` }}>
                    ...
                    <div style={{ marginLeft: "0.5rem", fontSize: "0.7rem", padding: "0.15rem 0.5rem", borderRadius: 20, background: "rgba(6,182,212,0.1)", color: "#22d3ee", fontWeight: 700 }}>
                ...
                {isLoading ? (
                  ...
                  <tr><td colSpan={9} style={{ textAlign: "center", padding: "4rem 1rem" }}>
                    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "0.75rem" }}>
                      <div style={{ width: 56, height: 56, borderRadius: 14, background: "rgba(6,182,212,0.08)", border: "1.5px dashed rgba(6,182,212,0.3)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                        <Ticket size={24} style={{ color: "#06b6d4", opacity: 0.6 }} />
                      </div>
                      <div>
                      ...
                      {vouchers.length === 0 && (
                        <button onClick={() => setShowGenerate(true)} style={{ marginTop: "0.25rem", display: "flex", alignItems: "center", gap: "0.375rem", padding: "0.5rem 1.25rem", borderRadius: 8, background: "linear-gradient(135deg,#06b6d4,#0284c7)", border: "none", color: "white", fontWeight: 700, fontSize: "0.8125rem", cursor: "pointer", fontFamily: "inherit" }}>
                  ...
                  return (
                    <tr key={v.code} className="vrow"
                      style={{ borderBottom: "1px solid var(--isp-border-subtle)", background: isSelected ? "rgba(6,182,212,0.05)" : "transparent", cursor: "pointer" }}
                      ...
                      <td style={{ padding: "0.7rem 1rem" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                          <code style={{ fontFamily: "monospace", fontWeight: 700, color: "#22d3ee", letterSpacing: "0.1em", fontSize: "0.875rem", filter: showCodes ? "none" : "blur(5px)", userSelect: showCodes ? "auto" : "none", transition: "filter 0.2s" }}>
                            {v.code}
                          </code>
                        </div>
                      </td>
                      <td style={{ padding: "0.7rem 1rem" }}>
                        <span style={{ fontSize: "0.8rem", padding: "0.2rem 0.6rem", borderRadius: 6, background: "rgba(6,182,212,0.1)", color: "#22d3ee", fontWeight: 600 }}>{v.plan_name}</span>
                      </td>
              ...
              <div style={{ display: "flex", gap: "0.5rem" }}>
                {selected.size === 0 && (
                  <button onClick={() => setSelected(new Set(filtered.map(v => v.code)))}
                    style={{ background: "none", border: "none", color: "#06b6d4", fontSize: "0.75rem", cursor: "pointer", fontFamily: "inherit", padding: 0, fontWeight: 600 }}>
