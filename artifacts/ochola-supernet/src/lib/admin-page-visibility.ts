...
export const ADMIN_PAGE_VISIBILITY_CATALOG: AdminVisibilitySection[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { key: "network.files", label: "Files", description: "View files stored on tenant routers." },
      ...
      { key: "network.multiport", label: "Multiport", description: "Isolated Hotspot and PPPoE services per physical router port." },
