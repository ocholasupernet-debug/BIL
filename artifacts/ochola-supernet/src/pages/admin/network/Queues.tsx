  ...
  return (
    <AdminLayout>
      <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
        <h1 style={{ fontSize: "1.25rem", fontWeight: 700, color: "var(--isp-text)", margin: 0 }}>Network — Queues</h1>
        <NetworkTabs active="queues" />
        <div style={{ borderRadius: 10, background: "var(--isp-section)", border: "1px solid var(--isp-border)", padding: "4rem 2rem", textAlign: "center" }}>
          ...
          <p style={{ fontSize: "0.8125rem", color: "var(--isp-text-muted)", margin: 0 }}>Queue management module is under active development.</p>
        </div>
      </div>
    </AdminLayout>
  );
