...
export function RouterLiveStats({
  ...
  return (
    <div style={{ borderTop: "1px solid rgba(6,182,212,0.15)", padding: "1rem 1.25rem 1.25rem" }}>
      {/* Header row */}
              ...
              return (
                <div key={t.iface} style={{ display: "flex", alignItems: "center", gap: "0.6rem" }}>
                  ...
                  <div style={{ flex: 1, height: 6, background: "rgba(255,255,255,0.06)", borderRadius: 3, overflow: "hidden" }}>
                    <div style={{ width: `${pct}%`, height: "100%", background: "linear-gradient(90deg,#06b6d4,#818cf8)", borderRadius: 3, transition: "width 0.6s ease" }} />
                  </div>
