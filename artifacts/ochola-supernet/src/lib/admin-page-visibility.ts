...
export const ADMIN_PAGE_VISIBILITY_CATALOG: AdminVisibilitySection[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { key: "network.add-router-script", label: "Direct installation", description: "Install a router with the standalone Main ISP configuration script." },
      ...
      { key: "network.resellers", label: "Reseller Ports", description: "Sub-agent accounts and physical port ownership." },
...
const ROUTE_FEATURES: Array<{ prefix: string; featureKey: string }> = [
  ...
  { prefix: "/admin/network/add-router-script", featureKey: "network.add-router-script" },
  ...
  { prefix: "/admin/resellers", featureKey: "network.resellers" },
