...
const CHANNEL_META: Record<string, { label: string; color: string; icon: React.ReactNode }> = {
  sms:      { label: "SMS",      color: "#06b6d4", icon: <Phone size={11} /> },
        ...
        <div style={{ padding: "1.25rem 1.5rem", display: "flex", flexDirection: "column", gap: "1rem" }}>
          ...
          <div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
              ...
              <button onClick={() => setShowPreview(!showPreview)} style={{ display: "flex", alignItems: "center", gap: 4, background: "none", border: "none", color: "#06b6d4", fontSize: "0.72rem", fontWeight: 700, cursor: "pointer", fontFamily: "inherit" }}>
          ...
          {showPreview && (
            <div style={{ padding: "1rem", borderRadius: 10, background: "rgba(6,182,212,0.06)", border: "1px solid rgba(6,182,212,0.15)" }}>
              <p style={{ fontSize: "0.68rem", fontWeight: 700, color: "#06b6d4", textTransform: "uppercase", margin: "0 0 6px" }}>Preview</p>
          ...
          <div style={{ display: "flex", gap: "0.75rem", marginTop: "0.5rem" }}>
            ...
            <button onClick={() => onSave(form)} style={{ flex: 2, padding: "0.6rem", borderRadius: 10, background: "linear-gradient(135deg,#06b6d4,#0284c7)", border: "none", color: "white", fontWeight: 700, fontSize: "0.85rem", cursor: "pointer", fontFamily: "inherit", display: "flex", alignItems: "center", justifyContent: "center", gap: 6 }}>
      ...
      <div style={{ maxWidth: 1000, margin: "0 auto", padding: "1.5rem" }}>
        <div style={{ marginBottom: "1.5rem" }}>
          ...
          <p style={{ fontSize: "0.82rem", color: "var(--isp-text-muted)", margin: "4px 0 0" }}>
            ...
            Use variables like <code style={{ background: "rgba(6,182,212,0.1)", padding: "1px 5px", borderRadius: 4, fontSize: "0.75rem", color: "#06b6d4" }}>[[name]]</code> to personalize messages.
          </p>
        </div>
            ...
            <div key={t.id} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "1rem 1.25rem", borderBottom: i < templates.length - 1 ? "1px solid var(--isp-border)" : "none" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8, flexShrink: 0 }}>
                <button onClick={() => toggleEnabled(t.id)} style={{
                  ...
                  background: t.enabled ? "#06b6d4" : "rgba(255,255,255,0.1)",
                ...
                <button onClick={() => setEditing(t)} style={{ padding: "6px 14px", borderRadius: 8, background: "rgba(6,182,212,0.08)", border: "1px solid rgba(6,182,212,0.2)", color: "#06b6d4", fontWeight: 700, fontSize: "0.75rem", cursor: "pointer", fontFamily: "inherit" }}>
                  Edit
                </button>
              </div>
            </div>
