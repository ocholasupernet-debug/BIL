  ...
  return (
    <div className="min-h-screen bg-[#080c10] text-slate-200 font-sans selection:bg-blue-500/30">
      ...
      <section className="pt-40 pb-20 px-6 relative">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-blue-500/20 blur-[120px] rounded-full pointer-events-none mix-blend-screen" />
        
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-xs font-bold tracking-wide uppercase mb-8">
      ...
      <section id="features" className="py-24 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <p className="text-blue-400 font-bold text-sm tracking-widest uppercase mb-3">Platform Features</p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            { title: "Customer Management", icon: Users, color: "text-blue-400", bg: "bg-blue-400/10", desc: "Full CRUD for PPPoE and hotspot customers. Manage expiry, renewal, and suspension." },
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-gradient-to-b from-blue-900/40 to-[#111820] border border-blue-500/30 rounded-3xl p-8 relative transform md:-translate-y-4 shadow-2xl shadow-blue-900/20">
              <div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-blue-400 to-blue-500 rounded-t-3xl" />
              <div className="absolute top-4 right-4 bg-blue-500/20 text-blue-400 text-xs font-bold px-3 py-1 rounded-full border border-blue-500/30">POPULAR</div>
