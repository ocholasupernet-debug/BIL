      ...
      <div style={{ background: "var(--isp-section)", border: "1px solid var(--isp-border)", borderRadius: 16, width: "100%", maxWidth: 600, maxHeight: "90vh", overflow: "auto", boxShadow: "0 24px 60px rgba(0,0,0,0.5)" }}>
        ...
        <div style={{ padding: "1.5rem" }}>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", marginBottom: "1.5rem" }}>
            ...
            <tfoot>
              <tr>
                ...
                <td style={{ textAlign: "right", fontSize: "0.95rem", fontWeight: 800, color: "#06b6d4" }}>{fmtMoney(invoice.total)}</td>
              </tr>
            </tfoot>
          </table>
          ...
          <div style={{ display: "flex", gap: "0.5rem" }}>
            <button style={{ flex: 1, padding: "0.6rem", borderRadius: 8, background: "rgba(6,182,212,0.1)", border: "1px solid rgba(6,182,212,0.3)", color: "#06b6d4", fontWeight: 700, fontSize: "0.8rem", cursor: "pointer", fontFamily: "inherit", display: "flex", alignItems: "center", justifyContent: "center", gap: 6 }}>
    ...
    <AdminLayout>
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "1.5rem" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "1.5rem" }}>
          ...
          <button style={{ padding: "0.55rem 1.25rem", borderRadius: 10, background: "linear-gradient(135deg,#06b6d4,#0284c7)", border: "none", color: "white", fontWeight: 700, fontSize: "0.82rem", cursor: "pointer", fontFamily: "inherit", display: "flex", alignItems: "center", gap: 6 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "1rem", marginBottom: "1.5rem" }}>
          {[
            { label: "Total Invoices", value: stats.count, icon: <FileText size={18} />, color: "#06b6d4" },
            { label: "Total Revenue", value: fmtMoney(stats.total), icon: <DollarSign size={18} />, color: "#34d399" },
            { label: "Collected", value: fmtMoney(stats.paid), icon: <TrendingUp size={18} />, color: "#22d3ee" },
              ...
              {filtered.map(inv => {
                ...
                return (
                  <tr key={inv.id} style={{ borderBottom: "1px solid var(--isp-border)" }}>
                    <td style={{ padding: "0.65rem 1rem", fontSize: "0.82rem", fontWeight: 700, color: "#06b6d4", fontFamily: "monospace" }}>{inv.invoice_number}</td>
                    ...
                    <td style={{ padding: "0.65rem 1rem" }}>
                      <div style={{ display: "flex", gap: 4 }}>
                        <button onClick={() => setPreview(inv)} style={{ padding: "5px 8px", borderRadius: 6, background: "rgba(6,182,212,0.08)", border: "1px solid rgba(6,182,212,0.2)", color: "#06b6d4", cursor: "pointer" }} title="View">
                          <Eye size={13} />
                        </button>
