...
import routerManualRouter from "./router-manual-route.js";
...
import superAdminRoutersRouter from "./super-admin-routers-route.js";
...
router.use(superAdminRoutersRouter);
